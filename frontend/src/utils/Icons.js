export const dashboard = <i className="fa-sharp fa-regular fa-address-card"></i>
export const transactions = <i className="fa-sharp fa-solid fa-right-left"></i>
...
export const piggy = <i className="fa-solid fa-coins"></i>
export const yt = <i className="fa-brands fa-youtube"></i>
export const card = <i className="fa-solid fa-wallet"></i>
...
export const book = <i className="fa-solid fa-book-open-reader"></i>
...
export const circle = <i className="fa-solid fa-coins"></i>
export const travelling= <i class="fa-solid fa-plane"></i>
